...
### 3. Built-in Functions (320+ functions across 32 categories)
...
#### Elasticsearch Core Functions (5)
- `ESQL_QUERY` - Execute ES|QL queries
- `INDEX_DOCUMENT`, `INDEX_BULK`, `UPDATE_DOCUMENT`
- `GET_DOCUMENT`, `REFRESH_INDEX`

#### Elasticsearch REST API Functions (139 total)
**Uses HTTP REST calls for stability across ES versions.**

**Document API (12 functions)** - `DocumentApiFunctions.java`
...
**Search API (16 functions)** - `SearchApiFunctions.java`
- `ES_SEARCH`, `ES_SEARCH_QUERY`, `ES_COUNT`, `ES_SCROLL`, `ES_SCROLL_NEXT`, `ES_CLEAR_SCROLL`
- `ES_MSEARCH`, `ES_FIELD_CAPS`, `ES_EXPLAIN`, `ES_SEARCH_TEMPLATE`
- `ES_KNN_SEARCH`, `ES_VALIDATE`, `ES_TERM_VECTORS`
- `ES_TERMS_AGG`, `ES_STATS_AGG`, `ES_DATE_HISTOGRAM`

**Index Management API (23 functions)** - `IndexApiFunctions.java`
- `ES_CREATE_INDEX`, `ES_DELETE_INDEX`, `ES_INDEX_EXISTS`, `ES_CLOSE_INDEX`, `ES_OPEN_INDEX`
- `ES_GET_MAPPING`, `ES_PUT_MAPPING`, `ES_GET_SETTINGS`, `ES_PUT_SETTINGS`
- `ES_INDEX_STATS`, `ES_REFRESH_INDEX`, `ES_FLUSH_INDEX`, `ES_FORCE_MERGE`, `ES_CLEAR_CACHE`
- `ES_SHRINK_INDEX`, `ES_ROLLOVER_INDEX`, `ES_CLONE_INDEX`
- `ES_GET_ALIAS`, `ES_PUT_ALIAS`, `ES_DELETE_ALIAS`
- `ES_GET_INDEX_TEMPLATE`, `ES_PUT_INDEX_TEMPLATE`, `ES_RESOLVE_INDEX`

**Cluster API (14 functions)** - `ClusterApiFunctions.java`
- `ES_CLUSTER_HEALTH`, `ES_CLUSTER_STATE`, `ES_CLUSTER_STATS`, `ES_CLUSTER_INFO`
...
- `ES_ALLOCATION_EXPLAIN`, `ES_REMOTE_INFO`

**ILM API (10 functions)** - `ILMApiFunctions.java`
- `ES_ILM_GET_POLICY`, `ES_ILM_PUT_POLICY`, `ES_ILM_DELETE_POLICY`
- `ES_ILM_EXPLAIN`, `ES_ILM_MOVE_TO_STEP`, `ES_ILM_RETRY`, `ES_ILM_REMOVE_POLICY`
- `ES_ILM_STATUS`, `ES_ILM_START`, `ES_ILM_STOP`

**Data Stream API (6 functions)** - `DataStreamApiFunctions.java`
...
**Snapshot API (9 functions)** - `SnapshotApiFunctions.java`
...
**Transform API (8 functions)** - `TransformApiFunctions.java`
- `ES_GET_TRANSFORM`, `ES_GET_TRANSFORM_STATS`, `ES_PUT_TRANSFORM`
- `ES_START_TRANSFORM`, `ES_STOP_TRANSFORM`, `ES_DELETE_TRANSFORM`
- `ES_PREVIEW_TRANSFORM`, `ES_RESET_TRANSFORM`

**Watcher API (10 functions)** - `WatcherApiFunctions.java`
...
**Security API (12 functions)** - `SecurityApiFunctions.java`
- `ES_GET_USERS`, `ES_CREATE_USER`, `ES_DELETE_USER`
- `ES_GET_ROLES`, `ES_CREATE_ROLE`, `ES_DELETE_ROLE`
...
#### Elastic Cloud Serverless Functions (39) - NEW
Elasticsearch Projects:
- `SERVERLESS_LIST_ES_PROJECTS`, `SERVERLESS_GET_ES_PROJECT`, `SERVERLESS_CREATE_ES_PROJECT`
- `SERVERLESS_UPDATE_ES_PROJECT`, `SERVERLESS_DELETE_ES_PROJECT`, `SERVERLESS_ES_PROJECT_STATUS`
- `SERVERLESS_ES_PROJECT_ROLES`, `SERVERLESS_RESET_ES_CREDENTIALS`, `SERVERLESS_RESUME_ES_PROJECT`

Observability Projects:
- `SERVERLESS_LIST_OBSERVABILITY_PROJECTS`, `SERVERLESS_GET_OBSERVABILITY_PROJECT`, `SERVERLESS_CREATE_OBSERVABILITY_PROJECT`
- `SERVERLESS_UPDATE_OBSERVABILITY_PROJECT`, `SERVERLESS_DELETE_OBSERVABILITY_PROJECT`, `SERVERLESS_OBSERVABILITY_PROJECT_STATUS`
- `SERVERLESS_OBSERVABILITY_PROJECT_ROLES`, `SERVERLESS_RESET_OBSERVABILITY_CREDENTIALS`, `SERVERLESS_RESUME_OBSERVABILITY_PROJECT`

Security Projects:
- `SERVERLESS_LIST_SECURITY_PROJECTS`, `SERVERLESS_GET_SECURITY_PROJECT`, `SERVERLESS_CREATE_SECURITY_PROJECT`
- `SERVERLESS_UPDATE_SECURITY_PROJECT`, `SERVERLESS_DELETE_SECURITY_PROJECT`, `SERVERLESS_SECURITY_PROJECT_STATUS`
- `SERVERLESS_SECURITY_PROJECT_ROLES`, `SERVERLESS_RESET_SECURITY_CREDENTIALS`, `SERVERLESS_RESUME_SECURITY_PROJECT`

Link Candidates & Regions:
- `SERVERLESS_ES_LINK_CANDIDATES`, `SERVERLESS_OBSERVABILITY_LINK_CANDIDATES`
- `SERVERLESS_SECURITY_LINK_CANDIDATES`, `SERVERLESS_WORKPLACE_AI_LINK_CANDIDATES`
- `SERVERLESS_LIST_REGIONS`, `SERVERLESS_GET_REGION`

Traffic Filters:
- `SERVERLESS_LIST_TRAFFIC_FILTERS`, `SERVERLESS_GET_TRAFFIC_FILTER`, `SERVERLESS_CREATE_TRAFFIC_FILTER`
- `SERVERLESS_UPDATE_TRAFFIC_FILTER`, `SERVERLESS_DELETE_TRAFFIC_FILTER`, `SERVERLESS_TRAFFIC_FILTER_METADATA`
