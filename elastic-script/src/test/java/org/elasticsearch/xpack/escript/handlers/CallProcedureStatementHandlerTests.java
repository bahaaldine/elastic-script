...
public class CallProcedureStatementHandlerTests extends ESIntegTestCase {
    ...
    public void testSimpleProcedureCall() throws Exception {
        ...
        ElasticScriptExecutor elasticScriptExecutor = new ElasticScriptExecutor(threadPool, client);
        ...
        elasticScriptExecutor.storeProcedureAsync("addNumbers", procedureText, ActionListener.wrap(
        ...
        ElasticScriptLexer callLexer = new ElasticScriptLexer(CharStreams.fromString(proc));
    ...
    public void testProcedureWithConditionalLogicAndNestedCalls() throws Exception {
        ...
        ElasticScriptExecutor elasticScriptExecutor = new ElasticScriptExecutor(threadPool, client);
        CountDownLatch storeLatch = new CountDownLatch(1);
        elasticScriptExecutor.storeProcedureAsync("isEven", isEvenProc, ActionListener.wrap(
            success -> storeLatch.countDown(),
            e -> {
        ...
        ElasticScriptLexer lexer = new ElasticScriptLexer(CharStreams.fromString(wrapperProc));
        CommonTokenStream tokens = new CommonTokenStream(lexer);
    ...
    public void testCallStoredProcedureViaExecutor() throws Exception {
        ...
        CountDownLatch storeLatch = new CountDownLatch(1);
        elasticScriptExecutor.storeProcedureAsync("add", procedureText, ActionListener.wrap(
            success -> storeLatch.countDown(),
            e -> {
                fail("Failed to store procedure: " + e.getMessage());
                storeLatch.countDown();
        ...
        elasticScriptExecutor.executeProcedure(callText, Map.of(), ActionListener.wrap(
            result -> {
