...
public class FunctionDefinitionHandler {
     ...
     */
    public void handleAsync(ElasticScriptParser.Function_definitionContext ctx, ActionListener<Object> listener) {
        try {
            ...
            List<ElasticScriptParser.StatementContext> functionBody = extractFunctionBody(ctx);
     ...
     */
    private List<ElasticScriptParser.StatementContext> extractFunctionBody(ElasticScriptParser.Function_definitionContext ctx) {
        List<ElasticScriptParser.StatementContext> functionBody = ctx.statement();
