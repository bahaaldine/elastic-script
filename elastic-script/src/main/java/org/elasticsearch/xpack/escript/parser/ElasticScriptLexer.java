...
public class ElasticScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MODEL", "TYPE", "TYPES", "RECORD", "END_TYPE", "AUTHID", "DEFINER", 
			"INVOKER", "SEARCH", "REFRESH", "QUERY", "MAPPINGS", "SETTINGS", "WHERE_CMD", 
			...
			"RAISE", "CODE", "ENDTRY", "FUNCTION", "FUNCTIONS", "RETURNS", "RETURN", 
			"BREAK", "CONTINUE", "SWITCH", "CASE", "DEFAULT", "END_SWITCH", "PERSIST", 
			"INTO", "CURSOR", "OPEN_CURSOR", "CLOSE_CURSOR", "FETCH", "LIMIT", "NOTFOUND", 
