...
public class ElasticScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CREATE", "DELETE", "DROP", "CALL", "PROCEDURE", "PROCEDURES", "IN", 
			"OUT", "INOUT", "DEFINE", "INTENT", "DESCRIPTION", "REQUIRES", "ACTIONS", 
			"ON_FAILURE", "WITH", "JOB", "TRIGGER", "SCHEDULE", "TIMEZONE", "ENABLED", 
			"ON_KW", "INDEX", "WHEN", "EVERY", "RUNS", "SHOW", "JOBS", "TRIGGERS", 
			"ALTER", "ENABLE", "DISABLE", "SECOND", "SECONDS", "MINUTE", "MINUTES", 
			"HOUR", "HOURS", "FORALL", "BULK_KW", "COLLECT", "SAVE_KW", "EXCEPTIONS", 
			"PACKAGE", "BODY", "END_PACKAGE", "PRIVATE", "PUBLIC", "GRANT", "REVOKE", 
			"EXECUTE", "PRIVILEGES", "ALL_PRIVILEGES", "TO", "OF", "ROLE", "USER", 
			"PERMISSIONS", "PROFILE", "PROFILES", "CLEAR", "ANALYZE", "APPLICATION", 
			"APPLICATIONS", "INSTALL", "EXTEND", "SKILL", "SKILLS", "INTENTS", "SOURCE", 
			"SOURCES", "VERSION", "CONFIG", "PAUSE", "RESUME", "HISTORY", "ADD", 
			"REMOVE", "MODIFY", "END_APPLICATION", "END_SKILL", "GENERATE", "EXAMPLES", 
			"MODEL", "CONNECTOR", "CONNECTORS", "SYNC", "INCREMENTAL", "OPTIONS", 
			"TEST_KW", "CONNECTOR_EXEC", "EXEC", "RUN", "ORDER", "BY", "ASC", "DESC", 
			"AGENT", "AGENTS", "GOAL", "INSTRUCTIONS", "TEMPERATURE", "MAX_TOKENS", 
			"MAX_ITERATIONS", "INFERENCE_ENDPOINT", "CHAT", "APPROVAL", "AUTONOMOUS", 
			"SUPERVISED", "DRY_RUN", "HUMAN_APPROVAL", "END_AGENT", "ALERT", "AUTHOR", 
			"TAGS", "LICENSE", "DEPRECATES", "PACK", "PACKS", "END_PACK", "EXPECT", 
			"TYPE", "TYPES", "RECORD", "END_TYPE", "AUTHID", "DEFINER", "INVOKER", 
	...
	public ElasticScriptLexer(CharStream input) {
		super(input);
