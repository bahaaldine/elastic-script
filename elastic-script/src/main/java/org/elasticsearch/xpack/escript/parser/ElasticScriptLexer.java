...
public class ElasticScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TEST_KW", "CONNECTOR_EXEC", "EXEC", "ORDER", "BY", "ASC", "DESC", "AGENT", 
			"AGENTS", "GOAL", "APPROVAL", "AUTONOMOUS", "SUPERVISED", "DRY_RUN", 
			"HUMAN_APPROVAL", "END_AGENT", "ALERT", "AUTHOR", "TAGS", "LICENSE", 
			"DEPRECATES", "PACK", "PACKS", "END_PACK", "EXPECT", "TYPE", "TYPES", 
			"RECORD", "END_TYPE", "AUTHID", "DEFINER", "INVOKER", "SEARCH", "REFRESH", 
			"QUERY", "MAPPINGS", "SETTINGS", "WHERE_CMD", "ESQL_PROCESS_PLACEHOLDER", 
